...
Trip Duration - How long each customer type rides
Day of Week Patterns - When each customer type rides (weekly patterns)
Time of Day Patterns - When each customer type rides (daily patterns)
...
Process and clean each monthly file individually
Create calculated fields in each monthly file
Verify data quality on smaller datasets
Merge files for full-year analysis

Data Integrity & Cleaning Strategy
Pre-Processing Verification:

✅ Confirm column consistency across all 12 monthly files
✅ Verify column names and data types match
✅ Check for structural issues before merging
